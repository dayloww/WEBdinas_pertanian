<nav x-data="{ open Master: true, openPublikasi: true }" class="w-72 min-h-screen bg-[#1a332a] text-white flex flex-col shadow-2xl z-50">
    ...
    <div class="flex-1 px-4 py-8 overflow-y-auto custom-scrollbar">
        <div class="space-y-8">
            <!-- Dashboard Link -->
            <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 rounded-xl {{ request()->routeIs('dashboard') ? 'bg-white/10 text-white border border-white/10' : 'text-white/60 hover:bg-white/5 hover:text-white' }} transition-all">
            ...
            <div>
                ...
                <div x-show="openMaster" x-transition class="mt-4 space-y-2">
                    <a href="#" class="flex items-center px-4 py-3 rounded-xl text-white/60 hover:bg-white/5 hover:text-white transition-all">
                    ...
                    <a href="{{ route('sectors.index') }}" class="flex items-center px-4 py-3 rounded-xl {{ request()->routeIs('sectors.*') || request()->routeIs('sector-data.*') ? 'bg-white/10 text-white' : 'text-white/60 hover:bg-white/5 hover:text-white' }} transition-all">
