<nav
    x-data="{
        openMaster: {{ request()->routeIs('admin.lands.*') || request()->routeIs('admin.sectors.*') || request()->routeIs('admin.sector-data.*') ? 'true' : 'false' }},
        openPublikasi: {{ request()->routeIs('admin.infographics.*') || request()->routeIs('admin.posts.*') || request()->routeIs('admin.galleries.*') ? 'true' : 'false' }}
    }"
    class="w-72 min-h-screen bg-[#1a332a] text-white flex flex-col shadow-2xl z-50"
>
    <!-- Brand -->
    ...
    <div class="flex-1 px-4 py-8 overflow-y-auto custom-scrollbar">
        <div class="space-y-8">
            ...
            <div>
                ...
                <div x-show="openMaster" x-transition x-cloak class="mt-4 space-y-2">
                    ...
                    <a href="{{ route('admin.sector-data.index') }}" class="flex items-center px-4 py-3 rounded-xl {{ request()->routeIs('admin.sector-data.*') ? 'bg-white/10 text-white' : 'text-white/60 hover:bg-white/5 hover:text-white' }} transition-all">
                        <svg class="w-5 h-5 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                        <span class="text-sm font-bold">Statistik</span>
                    </a>
                    <a href="{{ route('admin.sector-data.create') }}" class="flex items-center px-4 py-3 rounded-xl {{ request()->routeIs('admin.sector-data.create') ? 'bg-white/10 text-white' : 'text-white/60 hover:bg-white/5 hover:text-white' }} transition-all">
                        ...
                        <span class="text-sm font-bold">Tambah Statistik</span>
                    </a>
                    <a href="{{ route('admin.sectors.index') }}" class="flex items-center px-4 py-3 rounded-xl {{ request()->routeIs('admin.sectors.*') ? 'bg-white/10 text-white' : 'text-white/60 hover:bg-white/5 hover:text-white' }} transition-all">
                        <svg class="w-5 h-5 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.75 6.75h16.5v10.5H3.75zM8.25 6.75v10.5M15.75 6.75v10.5"></path></svg>
                        <span class="text-sm font-bold">Bidang</span>
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div x-show="openPublikasi" x-transition x-cloak class="mt-4 space-y-2">
